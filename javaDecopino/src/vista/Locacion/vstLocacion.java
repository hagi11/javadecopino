 ...
 * @author hamme
 */
public class vstLocacion extends javax.swing.JPanel {
    ...
    public void verLocaciones(){
        vstVerLocacion panel = new vstVerLocacion();
        vstMenu.panelContenedor(panel);
    }
    
    public void agregarLocacion(){
        vstAgregarEditarLocacion panel = new vstAgregarEditarLocacion();
        vstMenu.panelContenedor(panel);
    }
    /**
