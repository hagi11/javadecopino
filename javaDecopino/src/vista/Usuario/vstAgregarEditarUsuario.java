...
public class vstAgregarEditarUsuario extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panelRound10.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 100, 20));
        ...
        panelRound2.add(panelRound10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 450, 630, 40));
        ...
        jComboBox2.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 11)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione Tipo Identificacion", "C.C", "T.I", "PASAPORTE" }));
        panelRound12.add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 10, 210, 20));
        ...
        jComboBox3.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 11)); // NOI18N
        ...
        jComboBox4.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 11)); // NOI18N
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione Depto", "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        panelRound13.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, -1, 20));

        jPasswordField2.setBorder(null);
        panelRound13.add(jPasswordField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 10, 440, 20));

        panelRound2.add(panelRound13, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 490, 630, 40));
        ...
        panelRound14.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 70, 20));

        jComboBox5.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 11)); // NOI18N
        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione el Rol" }));
        panelRound14.add(jComboBox5, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, 170, 20));

        panelRound2.add(panelRound14, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 410, 630, 40));
