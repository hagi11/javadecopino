...
public class vstAgregarEditarUsuario extends javax.swing.JPanel {
    ...
    public void llenarComboRol() {
        ...
        listaRoles = ctrr.consultar();

        for (int posicion = 0; posicion < listaRoles.size(); posicion++) {
            System.out.println(listaRoles.get(posicion).getNombre());
...
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        panelRound12.add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 10, -1, 20));
        ...
        panelRound12.add(jComboBox5, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 10, -1, 20));
